...
/**
 * Footer body. Pure RSC: no client JS.
 * Lists `contact.socials` as external-safe links + the `legal` line.
 */
export default function FooterContent({contact, legal, className}: FooterContentProps) {
