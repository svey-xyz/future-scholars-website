...
// Query: *[_type == "settings"][0]{	...,	homepage->,	contact,	legal,	mobileNav,	navigation[]{		_type == "navLink" => {			  _key,  _type,  title,  link {    ...,    _type == "link" => {      "page": page->slug.current,      "post": post->slug.current    }  },  "resolvedTitle": coalesce(title, link.page->name, link.post->title, link.href)		},		_type == "navDropdown" => {			_key,			_type,			title,			links[]{				  _key,  _type,  title,  link {    ...,    _type == "link" => {      "page": page->slug.current,      "post": post->slug.current    }  },  "resolvedTitle": coalesce(title, link.page->name, link.post->title, link.href)			}		}	}}
